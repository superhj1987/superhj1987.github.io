...
- 最近非常火的OpenClaw，看到很多评价褒贬不一。其实对技术人员来说，之前的Claude code、Codex就能完成绝大部分任务了，所以用claude code的人普遍不太感冒。但对于没怎么使用过claude code的人说，这个确实是有价值的。不考虑安装的门槛，确实能自主完成很多复杂任务。而对于用过cc的人，打通im的通道这点也是有价值的，极大提升了调用agent的效率。不过，openclaw的安装门槛对于大众来说门槛还是有点高。

### 2024.04.12

- [road.sh](https://roadmap.sh): 一个不错的站点，涵盖了基本所有研发岗位的成长路线图。
