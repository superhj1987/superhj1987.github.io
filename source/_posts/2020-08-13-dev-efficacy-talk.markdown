...
对应于第一部分中讲述的软件开发流程，如果想要提升研发效能，那么需要落实到研发流程（组织结构、项目管理、持续交付）、工程方法、个人效能以管理和文化的实践上。本文重点从研发流程、工程方法来讲。
...
[项目管理标准模板](https://www.rowkey.cn/blog/2020/07/31/project-manage/)
...
打通研发流程中流动的多种标识信息，包括任务工单、代码提交号、版本号、代码审查 ID、测试用例 ID、Bug ID。

- 制品与源代码版本管理：project.properties
...
初创公司在业务刚起步时，使用 SaaS 或者 PaaS 快速开发业务；业务成长到一定规模之后，再逐步转到 IaaS 以及私有云降低成本。

- 妥善处理它带来的挑战，比如分布式系统带来的安全和控制方面的问题
...
- 测试右移：利用线上的真实环境测试；测试人员介入线上监控和预警，及时发现问题并跟进解决；混沌工程
...
[中台简谈](https://www.rowkey.cn/blog/2019/11/23/middle-talk/)
