...
其实一般的使用只需要掌握git的常用命令即可，但是在使用的过程中，常常会遇到各种复杂的需求，这时候经常需要搜索，非常麻烦，故总结了一下自己平常会用到的git操作。

![git-process](/images/blog_images/git-process.jpg)
...
## <a name="cherrypick"></a>选择某些commits操作
...
***ps: 以上部分参考自网上资料，如有侵权请联系superhj1987@126.com***